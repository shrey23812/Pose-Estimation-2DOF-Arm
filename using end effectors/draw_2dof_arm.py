...
class ARM2D(object):
	...
	def step(self, angle1, angle2):
		...
		pygame.draw.lines(self.screen, self.color_white, False, self.arm_1_point_list, self.arm_thickness)
		pygame.draw.lines(self.screen, self.color_white, False, self.arm_2_point_list, self.arm_thickness)

		# Save screenshot
		pygame.image.save(self.screen, "./images/" + "[{0:.2f},{0:.2f}]".format(self.arm_2_point_list[1][0],self.arm_2_point_list[1][1]) + ".jpg")
		# Print angle
